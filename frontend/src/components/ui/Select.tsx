...
const fieldClasses =
  'w-full px-4 py-3 rounded bg-ink-deep border border-border text-white ' +
  'outline-none transition-all duration-fast appearance-none pr-10 cursor-pointer ' +
  'focus:border-gold focus:shadow-[0_0_0_1px_rgb(var(--gold-foil)/0.3)] ' +
  'disabled:opacity-50 disabled:pointer-events-none'

export const Select = forwardRef<HTMLSelectElement, SelectProps>(function Select(
  { label, error, hint, options, className = '', children, id, ...rest },
  ref,
) {
  return (
