...
export function ThemeSwitcher() {
  ...
  return (
    <motion.button
      ...
      style={{
        background: `linear-gradient(135deg, rgb(var(--color-surface)), rgb(var(--color-ink)))`,
        borderColor: 'rgb(var(--accent-secondary)/ 0.4)',
        boxShadow: '0 4px 20px rgb(var(--accent-secondary)/ 0.3)',
      }}
